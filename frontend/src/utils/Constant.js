...
export const GET_EXERCISES = `${BASE_URL}/Exercise/GetAllExercises`;


export const GET_EXERCISE_COMMON_DATA_START = "GET_EXERCISE_COMMON_DATA_START";

export const GET_EXERCISE_COMMON_DATA_SUCCESS = "GET_EXERCISE_COMMON_DATA_SUCCESS";

export const GET_EXERCISE_COMMON_DATA_FAILED = "GET_EXERCISE_COMMON_DATA_FAILED";

export const GET_FILTER_EXERCISE_COMMON_DATA = "GET_FILTER_EXERCISE_COMMON_DATA";
